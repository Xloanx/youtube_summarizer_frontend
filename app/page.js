  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900 text-gray-900 dark:text-gray-100">
      ...
      <section className="py-16 px-5 text-center bg-gray-100 dark:bg-gray-800">
        <h2 className="text-3xl font-bold mb-8">Why Use Our AI?</h2>
      ...
      <footer className="py-8 text-center bg-gray-200 dark:bg-gray-800">
        <p className="text-gray-600 dark:text-gray-400">&copy; 2025 Gamma AI Video Summarizer. All rights reserved.</p>
      </footer>
    </div>
  );
}
